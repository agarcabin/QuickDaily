...
object WidgetAppearance {
    ...
    data class Colors(val background: Int, val foreground: Int, val muted: Int)
    ...
    fun colors(context: Context): Colors {
        ...
        val alpha = (prefs.getInt("widget_opacity", 100).coerceIn(0, 100) * 255 / 100)
        ...
        return Colors(background, foreground, muted)
    }
